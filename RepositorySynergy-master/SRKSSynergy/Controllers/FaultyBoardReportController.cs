...
{
    public class FaultyBoardReportController : Controller
    {
        private SRKS_Synergy db = new SRKS_Synergy();
        //
        // GET: /FaultyBoardReport/
        ...
        public ActionResult FaultyBoard(int page = 1, int rowsPerPage = 20, string cpnam = null, string cusnam = null, int ProductModelSparesID = 0, int dispst = -1, string fm = null, string tm = null)
        {
            int fm1 = 0, tm1 = 0;
            int fy1 = 0, ty1 = 0;
        ...
        public ActionResult ExportData(string cpnam = null, string cusnam = null, int ProductModelSparesID = 0, int dispst = -1, string fm = null, string tm = null)
        {
            ...
            dts.Columns.Add("QuantityOrdered", typeof(String));
            dts.Columns.Add("Faulty Spare Status", typeof(String));
                ...
                if (cpnam != "" && cusnam != "" && ProductModelSparesID == 0 && dispst == -1 && fm == "" && tm == "")
                {
                    ...
                    var dt = (from s in db.OutwardMFR
                              ...
                              select new
                              {
                                  ...
                                  s.QuantityOrdered,
                                  s.ProductModelSpare.ProductModelSparesID,
                                  s.FaultSpareDate
                              });
                    var dt1 = dt.ToList();
                    ...
                    {
                        var objMfr = db.MFR.Where(m => m.MFRNumber == d.MFRNo).FirstOrDefault();
                        var mfrdate = Convert.ToString(string.Format("{0:dd/MM/yyyy}", objMfr.MfrDate));
                        ...
                        dr[3] = mfrdate;
                        dr[4] = d.MFRNo;
                        dr[5] = d.ProductModelSparesID;
                        dr[6] = d.ProductSpareNameDesc;
                        dr[7] = d.QuantityOrdered;
                        dr[8] = d.FaultSpareDate;
                        dr[9] = objMfr.MFRComment;
                        dts.Rows.Add(dr);
                    }
                    gv.DataSource = dts;
