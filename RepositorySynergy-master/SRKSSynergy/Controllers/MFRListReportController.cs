...
{
    public class MFRListReportController : Controller
    {
        ...
        public ActionResult MFRList(int page = 1, int rowsPerPage = 20, string cpnam = null, string cusnam = null, int ProductModelSparesID = 0, int dispst = -1, string fm = null, string tm = null)
        {
